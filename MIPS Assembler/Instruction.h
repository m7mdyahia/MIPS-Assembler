...
public:
	...
	//Factory Method
	static Instruction* make_instr(const string & opcode_str);
...
{
public:
	RInstr(const string & fn_str_par, const string & instr_str_par);
private:
...
public:
	IInstr(int opcode_int_par, const string & instr_str_par);
};
...
public:
	JInstr(int opcode_int_par, const string & instr_str_par);
};
